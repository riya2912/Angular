...
let EmpAddressService = class EmpAddressService {
    constructor(http) {
        this.http = http;
...
EmpAddressService.ctorParameters = () => [
...
let EmployeeAddressComponent = class EmployeeAddressComponent {
...
EmployeeAddressComponent.ctorParameters = () => [
